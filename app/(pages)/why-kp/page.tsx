...
const Page = () => {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Content */}
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 md:px-8 flex flex-col gap-10 text-gray-800">
        {/* BEST INGREDIENTS */}
        <section>
          <h2 className="text-[#018578] text-xl sm:text-2xl md:text-3xl text-center font-bold mb-3">
            BEST INGREDIENTS
          </h2>
        ...
        <section>
          ...
          <p className="mt-2 text-base sm:text-lg leading-relaxed text-center sm:text-left">
        ...
        <section>
          ...
          <p className="mt-3 font-semibold text-base sm:text-lg text-center sm:text-left">
            What sets us apart:
          </p>
          <ul className="list-disc pl-6 mt-1 space-y-1 text-base sm:text-lg text-left">
