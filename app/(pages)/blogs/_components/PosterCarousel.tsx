...
const FullWidthPosterCarousel: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#f0fdfa] mb-10 mt-8">
      <Carousel
        setApi={setApi}
        opts={{
          align: "start",
      ...
      >
        <CarouselContent>
          {[1, 2, 3, 4].map((num) => (
            ...
            >
              <div
                className="flex items-center justify-center shadow-md border-2 border-[#018578] bg-white text-[#018578] text-5xl font-bold"
                style={{
                  width: "100vw",
                  height: "50vh",
                  minHeight: 200,
                  letterSpacing: "0.1em",
                  borderRadius: 0, // Remove roundedness
                }}
              >
                POSTER
              </div>
